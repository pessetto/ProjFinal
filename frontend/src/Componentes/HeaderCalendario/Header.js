...
const Header = () => {
  ...
  const PageDiaDia = ()=>{navigate('/PageDiaDia')}; 
  const PageAnual = ()=>{navigate('/PageAnual')}; 
  const PageGeral = ()=>{navigate('/PageGeral')}; 
  ...
  return (
    <div className="header">
      ...
      <nav className='conteiner_menu'>
            <a className='menu2' onClick={PageDiaDia}> Calendário</a>
            <a  className='menu2' onClick={PageAnual}> Anual </a>
            <a  className='menu2' onClick={PageGeral}> Geral </a>
        </nav>
